...
def configure_optimizers(lightning_module, config, optimizer_checkpoint):
    ...
    sched_steps = lightning_module.trainer.estimated_stepping_batches//config.accumulate_grads + 1
